...
> Mais cette première pièce, je ne la voyais pas "jouée" ; je l'avais d'ailleurs écrite comme un poème. Cependant, ce texte présente pour moi une profonde importance : parce que c'est une pièce très libre et située dans son milieu—le milieu antillais. C'est un peu comme la nébuleuse d'où sont sortis tous ces mondes successifs que constituent mes autres pièces.[^fn1] (28)
...
[^fn2]: I point here to David Scott's *Conscripts of Modernity: The Tragedy of Colonial Enlightenment*. In this work Scott makes a convincing argument that the shift from the 1st edition to the 2nd edition of CLR James' *Black Jacobins* carries a transition from anti-colonial romance to a salutary postcolonial tragedy due to a shift in James' "horizon of expectation." The concepts developed in Scott's volume resurface in my own work in various ways.

[^fn3]: For a narrative of how this text was discovered and a plot summary see my article "[Découverte d'un tapuscrit d'*Et les chiens se taisaient*](http://hdl.handle.net/10022/AC:P:14792)." ("découverte").

[^fn4]: Quotation marks indicate specific unpublished versions of the text, usually clear from context. When followed by parentheses with dates, italics indicate published versions. When not followed by dates, italics indicate *the work*—that mysterious construct with many bodies and none at all.
