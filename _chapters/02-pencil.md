...
The intimate bibliographic code of the Sain-Dié witness combined with its pagination schemes allowed us in chapter one to outline a rough, geometric schema for the stages of composition of "...et les chiens se taisaient" ([table p]({{site.baseurl}}/images/fig-p-full.png)). We could, though, make the geometric abstractions textual, by re-staging our material observations as fragmentary editions, somewhere between a quote and a full edition, hopefully fair in its transformative use as an aid to genetic analysis. Re-made into a new text, we will be better able to take into account the shifting terrain of the drama to refine our genetic gambit. We cannot do so without a certain degree of speculation, presenting the past as something that never existed until now, bound to the sample reality of a document that did—a conjectural criticism combined with a forensic imagination.

My approach is in part indebted to Kari Kraus, whose efforts to reunite speculative design's "Family of Subjunctive Practices" in her body of work amount to a welcome corrective for a multitode of ills: scientifism and the obverse fear of science, subservient fidelity to scholarly protocols, the . conjectural criticism (the reconstruction of literary texts) can be profitably understood as a sub-domain of Ramsay's algorithmic criticism (rule-governed manipulation of literary texts).
